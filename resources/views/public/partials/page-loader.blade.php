...
">
    <div style="position: relative; display: flex; align-items: center; justify-content: center;">
        ...
        ">
            @if($loaderLogo)
                <img src="{{ $loaderLogo }}" alt="Logo" style="width:100%;height:100%;object-fit:cover;">
            @else
                <span style="font-size:1.4rem;font-weight:900;color:{{ $loaderPrimary }};letter-spacing:-0.02em;font-family:'Manrope',sans-serif;">
                    {{ $loaderInitials }}
                </span>
            @endif
        </div>

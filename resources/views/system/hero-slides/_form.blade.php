...
<div class="grid grid-cols-1 gap-6 xl:grid-cols-[1.05fr_0.95fr]">
    <div class="space-y-6">
        <section class="overflow-hidden rounded-[2rem] border border-[#DDD8ED] bg-gradient-to-br from-[#24164A] via-[#25333E] to-[#43316F] text-white shadow-[0_28px_80px_-42px_rgba(17,24,39,0.55)]">
            <div class="grid gap-6 px-6 py-6 lg:grid-cols-[1.2fr_0.8fr] lg:px-7">
                ...
                <div id="hero-preview-mobile" class="relative hidden overflow-hidden rounded-[1.9rem] border border-[#D6DFF0] bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.82),transparent_38%),radial-gradient(circle_at_bottom_right,rgba(223,231,83,0.24),transparent_34%)] p-4">
                    ...
                    <div class="relative mx-auto max-w-[22rem] overflow-hidden rounded-[1.6rem] border border-[#D6DFF0] bg-white shadow-[0_24px_60px_-30px_rgba(15,23,42,0.35)]">
                        <div class="bg-[#25333E] px-4 py-3 text-white">
                        ...
                        <div class="p-4">
                            <p id="hero-preview-mobile-pill" class="inline-flex items-center rounded-full border border-[#DFE753] bg-white px-3 py-1 text-[11px] font-semibold tracking-tight text-[#25333E]">{{ $previewBadge }}</p>
                            ...
                            <div class="mt-5 space-y-3">
                                <span id="hero-preview-mobile-btn-one" class="inline-flex w-full items-center justify-center rounded-full bg-[#25333E] px-5 py-3 text-sm font-bold text-white">{{ $previewButtonOne }}</span>
                                <span id="hero-preview-mobile-btn-two" class="inline-flex w-full items-center justify-center rounded-full border border-[#25333E]/25 bg-white px-5 py-3 text-sm font-bold text-[#25333E]">{{ $previewButtonTwo }}</span>
                            </div>
                            <div class="relative mt-5 overflow-hidden rounded-[1.4rem] border border-[#25333E]/10 bg-[#24164A]">
                                <div class="relative aspect-[4/4.2] overflow-hidden">
                                    ...
                                    <div id="hero-preview-mobile-placeholder" class="{{ $currentImage && !$placeholderVisual ? 'hidden ' : '' }}absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.12),transparent_28%),linear-gradient(135deg,#201244_0%,#25333E_45%,#4D3A87_100%)]"></div>
                            ...
                            <div class="mt-4 rounded-[1.25rem] border border-[#25333E]/12 bg-[#FBFAFE] p-4">
                                <p id="hero-preview-mobile-school" class="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#25333E]/60">{{ $previewSchool }}</p>
        ...
        <section class="rounded-[2rem] border border-[#DDD8ED] bg-white p-6 shadow-sm">
            <div class="flex items-start justify-between gap-4">
                <div>
                    <p class="text-xs font-semibold uppercase tracking-[0.24em] text-[#25333E]/55">Content Layer</p>
                    <h3 class="mt-3 text-xl font-black text-slate-900">Slide message and positioning</h3>
                </div>
                <span class="inline-flex rounded-full bg-[#F3F0FB] px-3 py-1 text-xs font-semibold text-[#25333E]">Left content column</span>
            </div>

            <div class="mt-6 grid grid-cols-1 gap-5">
                <div>
                    <label class="mb-2 block text-sm font-semibold text-slate-800">Badge Text</label>
                    <input id="hero-badge-input" type="text" name="badge_text" value="{{ old('badge_text', $slide->badge_text) }}" class="w-full rounded-2xl border-slate-300 bg-slate-50 px-4 py-3 focus:border-[#25333E] focus:ring-[#25333E]/20" maxlength="120" required>
                </div>
                <div>
                    <label class="mb-2 block text-sm font-semibold text-slate-800">Main Heading</label>
                    <textarea id="hero-title-input" name="title" rows="3" class="w-full rounded-2xl border-slate-300 bg-slate-50 px-4 py-3 focus:border-[#25333E] focus:ring-[#25333E]/20" maxlength="255" required>{{ old('title', $slide->title) }}</textarea>
                ...
                <div>
                    ...
                    <textarea id="hero-subtitle-input" name="subtitle" rows="4" class="w-full rounded-2xl border-slate-300 bg-slate-50 px-4 py-3 focus:border-[#25333E] focus:ring-[#25333E]/20" maxlength="1500" required>{{ old('subtitle', $slide->subtitle) }}</textarea>
        ...
        <section class="rounded-[2rem] border border-[#DDD8ED] bg-white p-6 shadow-sm">
            <div class="flex items-start justify-between gap-4">
                <div>
                    <p class="text-xs font-semibold uppercase tracking-[0.24em] text-[#25333E]/55">Call To Action</p>
                    <h3 class="mt-3 text-xl font-black text-slate-900">Buttons and navigation flow</h3>
                </div>
                <span class="inline-flex rounded-full bg-[#F3F0FB] px-3 py-1 text-xs font-semibold text-[#25333E]">Two CTA buttons</span>
            </div>

            <div class="mt-6 grid grid-cols-1 gap-5 md:grid-cols-2">
                <div>
                    <label class="mb-2 block text-sm font-semibold text-slate-800">Button 1 Text</label>
                    <input id="hero-btn-one-text" type="text" name="button_1_text" value="{{ old('button_1_text', $slide->button_1_text) }}" class="w-full rounded-2xl border-slate-300 bg-slate-50 px-4 py-3 focus:border-[#25333E] focus:ring-[#25333E]/20" maxlength="80" required>
                </div>
                <div>
                    <label class="mb-2 block text-sm font-semibold text-slate-800">Button 1 Link</label>
                    <input type="text" name="button_1_link" value="{{ old('button_1_link', $slide->button_1_link) }}" class="w-full rounded-2xl border-slate-300 bg-slate-50 px-4 py-3 focus:border-[#25333E] focus:ring-[#25333E]/20" maxlength="255" required>
                </div>
                <div>
                    <label class="mb-2 block text-sm font-semibold text-slate-800">Button 2 Text</label>
                    <input id="hero-btn-two-text" type="text" name="button_2_text" value="{{ old('button_2_text', $slide->button_2_text) }}" class="w-full rounded-2xl border-slate-300 bg-slate-50 px-4 py-3 focus:border-[#25333E] focus:ring-[#25333E]/20" maxlength="80" required>
                </div>
                <div>
                    <label class="mb-2 block text-sm font-semibold text-slate-800">Button 2 Link</label>
                    <input type="text" name="button_2_link" value="{{ old('button_2_link', $slide->button_2_link) }}" class="w-full rounded-2xl border-slate-300 bg-slate-50 px-4 py-3 focus:border-[#25333E] focus:ring-[#25333E]/20" maxlength="255" required>
                </div>
            </div>
        ...
        <section class="rounded-[2rem] border border-[#DDD8ED] bg-white p-6 shadow-sm">
            <div class="flex items-start justify-between gap-4">
                <div>
                    <p class="text-xs font-semibold uppercase tracking-[0.24em] text-[#25333E]/55">Right Visual Card</p>
                    <h3 class="mt-3 text-xl font-black text-slate-900">Floating message card</h3>
                </div>
                <span class="inline-flex rounded-full bg-[#F3F0FB] px-3 py-1 text-xs font-semibold text-[#25333E]">Image overlay support</span>
            </div>

            <div class="mt-6 grid grid-cols-1 gap-5">
                <div>
                    <label class="mb-2 block text-sm font-semibold text-slate-800">School Name</label>
                    <input id="hero-school-input" type="text" name="school_name" value="{{ old('school_name', $slide->school_name ?: auth()->user()->school?->name) }}" class="w-full rounded-2xl border-slate-300 bg-slate-50 px-4 py-3 focus:border-[#25333E] focus:ring-[#25333E]/20" maxlength="160" required>
                </div>
                <div>
                    <label class="mb-2 block text-sm font-semibold text-slate-800">Right Card Title</label>
                    <input id="hero-card-title-input" type="text" name="right_card_title" value="{{ old('right_card_title', $slide->right_card_title) }}" class="w-full rounded-2xl border-slate-300 bg-slate-50 px-4 py-3 focus:border-[#25333E] focus:ring-[#25333E]/20" maxlength="160" required>
                </div>
                <div>
                    <label class="mb-2 block text-sm font-semibold text-slate-800">Right Card Text</label>
                    <textarea id="hero-card-text-input" name="right_card_text" rows="4" class="w-full rounded-2xl border-slate-300 bg-slate-50 px-4 py-3 focus:border-[#25333E] focus:ring-[#25333E]/20" maxlength="1000" required>{{ old('right_card_text', $slide->right_card_text) }}</textarea>
                </div>
            </div>
        </section>
    </div>
    ...
    <div class="space-y-6">
        <section class="rounded-[2rem] border border-[#DDD8ED] bg-white p-6 shadow-sm">
            <div class="flex items-start justify-between gap-4">
                <div>
                    <p class="text-xs font-semibold uppercase tracking-[0.24em] text-[#25333E]/55">Visual Media</p>
            ...
            <div class="mt-6 space-y-5">
                <label class="block rounded-[1.6rem] border border-dashed border-[#BDB2DD] bg-[#F7F5FC] p-5 text-sm text-slate-600">
                    ...
                    <input id="hero-image-input" type="file" name="image" accept=".jpg,.jpeg,.png,.webp,image/jpeg,image/png,image/webp" class="mt-4 block w-full rounded-2xl border-slate-300 bg-white file:mr-4 file:rounded-full file:border-0 file:bg-[#25333E] file:px-4 file:py-2.5 file:text-sm file:font-semibold file:text-white hover:file:bg-[#43316F]" {{ $isEdit ? '' : 'required' }}>
                </label>

                <div class="grid gap-4 md:grid-cols-3">
                    <article class="rounded-[1.4rem] border border-[#E7E2F4] bg-[#F8F7FD] p-4">
                        <p class="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#25333E]/55">Source Ratio</p>
                        <div class="mt-3 flex items-center gap-3">
                            <div class="flex h-10 w-16 items-center justify-center rounded-lg bg-[#25333E] text-[10px] font-bold uppercase tracking-[0.2em] text-white">3:2</div>
                            <div>
                    ...
                    <article class="rounded-[1.4rem] border border-[#E7E2F4] bg-[#F8F7FD] p-4">
                        <p class="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#25333E]/55">Visible Crop</p>
                        <div class="mt-3 flex items-center gap-3">
                            <div class="flex h-12 w-10 items-center justify-center rounded-lg border-2 border-[#DFE753] bg-[#25333E]/90"></div>
                            <div>
                    ...
                    <article class="rounded-[1.4rem] border border-[#E7E2F4] bg-[#F8F7FD] p-4">
                        <p class="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#25333E]/55">Safe Focus Area</p>
                        <div class="mt-3 flex items-center gap-3">
                            <div class="relative h-12 w-16 rounded-lg bg-[#25333E]">
                ...
                <div class="rounded-[1.5rem] border border-[#E7E2F4] bg-[#FBFAFE] p-5">
                    <div class="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                        <div>
                            <p class="text-xs font-semibold uppercase tracking-[0.18em] text-[#25333E]/55">Cropping Guidance</p>
                        ...
                        <div class="rounded-[1.25rem] border border-[#25333E]/10 bg-white p-4 shadow-sm">
                            <p class="text-xs font-semibold uppercase tracking-[0.18em] text-[#25333E]/55">Best Banner Rule</p>
        ...
        <section class="rounded-[2rem] border border-[#DDD8ED] bg-white p-6 shadow-sm">
            <div class="flex items-start justify-between gap-4">
                <div>
                    <p class="text-xs font-semibold uppercase tracking-[0.24em] text-[#25333E]/55">Live Preview</p>
                ...
                <div class="flex flex-wrap items-center gap-2">
                    <span class="inline-flex rounded-full bg-[#F3F0FB] px-3 py-1 text-xs font-semibold text-[#25333E]">Public hero match</span>
                    <div class="inline-flex rounded-full border border-[#D9D4EA] bg-[#F8F7FD] p-1">
                        <button type="button" id="hero-preview-desktop-tab" data-preview-target="desktop" class="rounded-full bg-[#25333E] px-3 py-1.5 text-xs font-semibold text-white transition">Desktop</button>
                        <button type="button" id="hero-preview-mobile-tab" data-preview-target="mobile" class="rounded-full px-3 py-1.5 text-xs font-semibold text-[#25333E] transition">Mobile</button>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-6 rounded-[2rem] border border-[#E3DEF0] bg-[#EEF6FF] p-4 shadow-inner">
                <div id="hero-preview-desktop" class="relative overflow-hidden rounded-[1.9rem] border border-[#D6DFF0] bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.82),transparent_38%),radial-gradient(circle_at_bottom_right,rgba(223,231,83,0.24),transparent_34%)] p-4 sm:p-5">
                    ...
                    <div class="relative overflow-hidden rounded-[1.5rem] border border-white/60 bg-[#25333E] px-4 py-3 shadow-[0_18px_45px_-24px_rgba(15,23,42,0.35)]">
                        <div class="flex items-center justify-between gap-4">
                            ...
                            <div class="hidden items-center gap-2 md:flex">
                                <span class="inline-flex rounded-full border border-white/15 bg-white px-4 py-2 text-xs font-semibold text-[#25333E]">Programs</span>
                                <span class="inline-flex rounded-full border border-white/15 bg-white px-4 py-2 text-xs font-semibold text-[#25333E]">Admissions</span>
                                <span class="inline-flex rounded-full border border-white/15 bg-white px-4 py-2 text-xs font-semibold text-[#25333E]">Academics</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="relative mt-5 grid gap-6 lg:grid-cols-[1.02fr_0.98fr] lg:gap-8">
                        <div class="max-w-3xl pt-2">
                            <p id="hero-preview-badge" class="inline-flex items-center rounded-full border border-[#DFE753] bg-white/85 px-4 py-1.5 text-sm font-semibold tracking-tight text-[#25333E] shadow-sm backdrop-blur">{{ $previewBadge }}</p>
                            ...
                            <div class="mt-8 flex flex-wrap gap-4">
                                <span id="hero-preview-btn-one" class="inline-flex items-center rounded-full bg-[#25333E] px-7 py-3.5 text-sm font-bold text-white shadow-[0_18px_35px_-16px_rgba(15,23,42,0.35)]">{{ $previewButtonOne }}</span>
                                <span id="hero-preview-btn-two" class="inline-flex items-center rounded-full border border-[#25333E]/30 bg-white/90 px-7 py-3.5 text-sm font-bold text-[#25333E] shadow-sm backdrop-blur">{{ $previewButtonTwo }}</span>
                            </div>

                            <div class="mt-8 flex items-center gap-2">
                                <span class="h-2.5 w-7 rounded-full bg-[#25333E]"></span>
                                <span class="h-2.5 w-2.5 rounded-full bg-[#25333E]/25"></span>
                                <span class="h-2.5 w-2.5 rounded-full bg-[#25333E]/25"></span>
                                <span class="h-2.5 w-2.5 rounded-full bg-[#25333E]/25"></span>
                            </div>
                        </div>
                        ...
                        <div class="relative lg:pl-4">
                            <div class="relative overflow-hidden rounded-[2rem] border border-[#25333E]/10 bg-white shadow-[0_30px_80px_-35px_rgba(15,23,42,0.5)]">
                                <div class="relative aspect-[4/4.15] min-h-[24rem] overflow-hidden bg-[#24164A] sm:min-h-[28rem]">
                                    ...
                                    <div id="hero-preview-placeholder" class="{{ $currentImage && !$placeholderVisual ? 'hidden ' : '' }}absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.12),transparent_28%),linear-gradient(135deg,#201244_0%,#25333E_45%,#4D3A87_100%)]"></div>
                            ...
                            <div class="absolute -bottom-6 left-4 max-w-[18rem] rounded-[1.5rem] border border-[#25333E]/15 bg-white/95 p-4 shadow-[0_24px_55px_-24px_rgba(15,23,42,0.4)] backdrop-blur sm:left-[-1.25rem] sm:p-5">
                                <p id="hero-preview-school" class="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#25333E]/60">{{ $previewSchool }}</p>
        ...
        <section class="rounded-[2rem] border border-[#DDD8ED] bg-white p-6 shadow-sm">
            <p class="text-xs font-semibold uppercase tracking-[0.24em] text-[#25333E]/55">Publishing</p>
            ...
            <div class="mt-6 space-y-5">
                <div>
                    ...
                    <select name="order" class="w-full rounded-2xl border-slate-300 bg-slate-50 px-4 py-3 focus:border-[#25333E] focus:ring-[#25333E]/20" required>
                ...
                <label class="flex items-start gap-3 rounded-[1.5rem] border border-[#E7E2F4] bg-[#F8F7FD] px-4 py-4">
                    <input type="checkbox" name="is_active" value="1" class="mt-1 rounded border-gray-300 text-[#25333E] focus:ring-[#25333E]" @checked((bool) old('is_active', $slide->is_active ?? true))>
                    <span>
        ...
        <div class="flex flex-wrap items-center gap-3">
            <button type="submit" class="inline-flex items-center rounded-full bg-[#25333E] px-6 py-3 text-sm font-bold text-white transition duration-200 hover:-translate-y-0.5 hover:bg-[#DFE753] hover:text-[#25333E]">
                {{ $isEdit ? 'Update Slide' : 'Create Slide' }}
            </button>
            <a href="{{ route('system.hero-slides.index') }}" class="inline-flex items-center rounded-full border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-700 transition duration-200 hover:-translate-y-0.5 hover:border-[#25333E] hover:text-[#25333E]">
                Cancel
            </a>
        </div>
    </div>
    ...
    (() => {
        ...
        const activatePreview = (mode) => {
            ...
            desktopTab.className = desktopActive
                ? 'rounded-full bg-[#25333E] px-3 py-1.5 text-xs font-semibold text-white transition'
                : 'rounded-full px-3 py-1.5 text-xs font-semibold text-[#25333E] transition';

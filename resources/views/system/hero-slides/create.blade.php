...
<div class="space-y-6">
    <section class="rounded-[2rem] border border-[#DDD8ED] bg-white p-6 shadow-sm">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <a href="{{ route('system.hero-slides.index') }}" class="inline-flex items-center rounded-full border border-[#25333E]/15 bg-white px-5 py-2.5 text-sm font-semibold text-[#25333E] transition duration-200 hover:-translate-y-0.5 hover:border-[#DFE753] hover:bg-[#DFE753]">
                Back to Hero Slides
            </a>
        </div>
    </section>

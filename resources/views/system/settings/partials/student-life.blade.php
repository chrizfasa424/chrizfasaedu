<form action="{{ route('settings.public-page') }}" method="POST" class="space-y-8">
    ...
    <button type="submit" class="inline-flex items-center rounded-2xl bg-[#25333E] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#DFE753] hover:text-[#25333E]">Save Student Life Page</button>
</form>

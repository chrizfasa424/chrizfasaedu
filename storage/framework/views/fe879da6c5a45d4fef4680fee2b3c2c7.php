                ...
                <nav class="hidden items-center gap-1.5 rounded-full border border-slate-200/90 bg-white/90 p-1.5 text-sm font-semibold text-slate-600 shadow-sm xl:flex" style="--submenu-secondary: <?php echo e($submenuSecondaryColor); ?>; --submenu-hover-text: <?php echo e($submenuHoverTextColor); ?>;">
                    <?php $__currentLoopData = $menuSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="relative" data-menu="<?php echo e($section['id']); ?>">
                            ...
                            <?php else: ?>
                                <a href="<?php echo e($section['link']); ?>" class="theme-nav-link inline-flex items-center rounded-full px-4 py-2.5 transition duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500/40">
                                    <?php echo e($section['label']); ?>
            ...
            <section class="mx-auto max-w-7xl px-6 pb-14 pt-16 lg:px-8 lg:pt-20">
                <div class="grid gap-8 lg:grid-cols-3">
                    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm lg:col-span-2">
                        <p class="inline-flex rounded-full border border-brand-200 bg-brand-50 px-3 py-1 text-xs font-bold uppercase tracking-[0.18em] text-brand-700"><?php echo e($sectionLabel); ?></p>
                        <h1 class="mt-4 font-display text-3xl font-semibold leading-tight text-slate-900 sm:text-4xl"><?php echo e($item['title']); ?></h1>
                        <p class="mt-5 max-w-3xl text-base leading-relaxed text-muted sm:text-lg"><?php echo e($item['description']); ?></p>

                        <div class="mt-7 grid gap-4 sm:grid-cols-2">
                            <article class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                                <h2 class="text-sm font-bold uppercase tracking-wide text-brand-700"><?php echo e($submenuHighlightOneTitle !== '' ? $submenuHighlightOneTitle : 'What Students Gain'); ?></h2>
                                <p class="mt-2 text-sm leading-relaxed text-slate-600"><?php echo e($submenuHighlightOneText !== '' ? $submenuHighlightOneText : 'Learners receive practical support, clear expectations, and measurable progress across this focus area.'); ?></p>
                            </article>
                            <article class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                                <h2 class="text-sm font-bold uppercase tracking-wide text-brand-700"><?php echo e($submenuHighlightTwoTitle !== '' ? $submenuHighlightTwoTitle : 'How We Deliver'); ?></h2>
                                <p class="mt-2 text-sm leading-relaxed text-slate-600"><?php echo e($submenuHighlightTwoText !== '' ? $submenuHighlightTwoText : 'Delivery is structured to be balanced and moderate, so parents and students can follow the process with confidence.'); ?></p>
                            </article>
                        </div>

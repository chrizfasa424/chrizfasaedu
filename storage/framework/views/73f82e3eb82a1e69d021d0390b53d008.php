<?php $__env->startSection('title', 'Import Results'); ?>
<?php $__env->startSection('header', 'Import Results'); ?>
...
<div class="space-y-6 max-w-2xl">
    ...
    <div class="rounded-2xl border border-blue-200 bg-blue-50 p-5">
        ...
        <div class="mt-3 flex items-center gap-3">
            <a href="<?php echo e(route('examination.results.template')); ?>"
    ...
    ?>
    <?php if($sampleStudents->isNotEmpty()): ?>
    <div class="rounded-2xl border border-amber-200 bg-amber-50 p-5">
        <h3 class="text-sm font-semibold text-amber-800 mb-2">Sample Admission Numbers (use these in your CSV)</h3>
        <div class="flex flex-wrap gap-2">
            <?php $__currentLoopData = $sampleStudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <span class="rounded-lg bg-white border border-amber-200 px-3 py-1 text-xs font-mono text-amber-800">
                <?php echo e($s->admission_number); ?> — <?php echo e($s->first_name); ?> <?php echo e($s->last_name); ?>
    ...
    <form method="POST" action="<?php echo e(route('examination.results.import.store')); ?>" enctype="multipart/form-data"
        ...
        <div>
            ...
            <select name="class_id" required class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400">
                ...
                <option value="<?php echo e($c->id); ?>" <?php echo e(old('class_id') == $c->id ? 'selected' : ''); ?>><?php echo e($c->grade_level?->label() ?? $c->name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        ...
        <div>
            ...
            <select name="term_id" required class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400">
                ...
                <option value="<?php echo e($t->id); ?>" <?php echo e(old('term_id') == $t->id ? 'selected' : ''); ?>>
        ...
        <div class="flex justify-end gap-2 pt-2">
            <a href="<?php echo e(route('examination.results.index')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\chrizfasaedu\resources\views/examination/results/import.blade.php ENDPATH**/ ?>
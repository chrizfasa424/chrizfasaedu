...
<body class="text-ink antialiased" style="background-color: <?php echo e($siteBackgroundColor); ?>; color: <?php echo e($themeBodyColor); ?>; --submenu-primary: <?php echo e($submenuPrimaryColor); ?>; --submenu-secondary: <?php echo e($submenuSecondaryColor); ?>; --submenu-hover-text: <?php echo e($submenuHoverTextColor); ?>; --theme-heading: <?php echo e($themeHeadingColor); ?>; --theme-body: <?php echo e($themeBodyColor); ?>; --theme-surface: <?php echo e($themeSurfaceColor); ?>; --theme-soft-surface: <?php echo e($themeSoftSurfaceColor); ?>; <?php echo e($tailwindThemeVars); ?>;">
    ...
    <div class="relative min-h-screen overflow-x-hidden">
        ...
        <header class="sticky top-0 z-50 backdrop-blur" style="background-color: <?php echo e($headerBgColor); ?>;">
            <div class="mx-auto grid max-w-7xl grid-cols-[auto_1fr_auto] items-center gap-4 px-6 py-3 lg:px-8">
                ...
                <nav class="hidden items-center justify-center gap-1 rounded-2xl bg-white/95 px-2 py-1.5 text-sm font-semibold text-slate-600 shadow-sm xl:flex" style="--submenu-secondary: <?php echo e($submenuSecondaryColor); ?>; --submenu-hover-text: <?php echo e($submenuHoverTextColor); ?>;">
                                ...
                                <div class="faq-answer hidden overflow-hidden">
                                    <div class="border-t border-slate-100 px-5 pb-5 pt-4">
                                        <div class="flex gap-3">
                                            ...
                                            <div class="text-sm leading-relaxed text-slate-600 rich-text-content space-y-1"><?php echo \App\Support\RichText::render($faq['a'] ?? ''); ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="relative overflow-hidden rounded-[2rem] bg-white/95 p-6 shadow-[0_24px_50px_-38px_rgba(15,23,42,0.5)] lg:p-8">
                    ...
                    <div class="relative space-y-8">
                        <div class="flex flex-wrap items-center gap-2">
                            <span class="inline-flex items-center rounded-full border border-brand-200 bg-brand-50 px-3.5 py-1 text-[11px] font-bold uppercase tracking-[0.16em] text-brand-700"><?php echo e($sectionLabel); ?></span>
                            <span class="inline-flex items-center rounded-full bg-white px-3.5 py-1 text-[11px] font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e($readingMinutes); ?> min read</span>
                        </div>

                        <div class="rich-text-content max-w-4xl text-base leading-relaxed text-muted sm:text-lg"><?php echo \App\Support\RichText::render($displayDescription); ?></div>
                        ...
                        <div class="grid gap-4 sm:grid-cols-12">
                            <?php if($pageImgOne !== ''): ?>
                            <figure class="overflow-hidden rounded-3xl bg-white shadow-sm <?php echo e($pageImgTwo !== '' ? 'sm:col-span-8' : 'sm:col-span-12'); ?>">
                        ...
                        <div class="grid gap-4 lg:grid-cols-2">
                            ...
                            <article class="rounded-2xl bg-gradient-to-br from-secondary-50 via-white to-white p-5 shadow-sm">
                                ...
                                <h2 class="text-sm font-bold uppercase tracking-wide text-slate-800"><?php echo e($h2Title); ?></h2>
                        ...
                        <div class="flex flex-wrap items-center gap-3 pt-1">
                            <a href="<?php echo e(route('admission.apply')); ?>" class="inline-flex items-center gap-2 rounded-full bg-slate-900 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition duration-200 hover:-translate-y-0.5 hover:bg-slate-800">
                                ...
                                <?php echo e($submenuPrimaryButtonText !== '' ? $submenuPrimaryButtonText : 'Start Admission'); ?>

                            </a>
                            <a href="<?php echo e(route('public.home')); ?>#<?php echo e($sectionKey); ?>" class="inline-flex items-center gap-2 rounded-full border border-slate-300 bg-white px-5 py-2.5 text-sm font-semibold text-slate-700 transition duration-200 hover:-translate-y-0.5 hover:border-slate-500 hover:text-slate-900">
                                ...
                                <?php echo e($submenuBackButtonPrefix !== '' ? $submenuBackButtonPrefix : 'Back to'); ?> <?php echo e($sectionLabel); ?>

                            </a>
                            <a href="<?php echo e(route('public.contact')); ?>" class="inline-flex items-center gap-2 rounded-full border border-brand-200 bg-brand-50 px-5 py-2.5 text-sm font-semibold text-brand-700 transition duration-200 hover:-translate-y-0.5 hover:border-brand-300 hover:bg-brand-100">
                ...
                <?php endif; ?>
                    ...
                    <aside class="self-start overflow-hidden rounded-[1.75rem] border bg-white shadow-[0_24px_50px_-40px_rgba(15,23,42,0.55)] lg:sticky lg:top-28" style="border-color:#22323C;">
                        <div class="px-5 py-4" style="background-color: var(--submenu-secondary, #DFE753); color: var(--submenu-hover-text, #2D1D5C);">
                            <p class="text-[11px] font-semibold uppercase tracking-[0.18em]" style="color: var(--submenu-hover-text, #2D1D5C); opacity: 0.82;"><?php echo e($sectionLabel); ?></p>
                            <h2 class="mt-1 font-display text-2xl font-semibold"><?php echo e($submenuMoreInPrefix !== '' ? $submenuMoreInPrefix : 'More In'); ?> <?php echo e($sectionLabel); ?></h2>
                        </div>
                        <div class="p-4">
                            <div class="space-y-2.5" style="--submenu-primary: <?php echo e($submenuPrimaryColor); ?>; --submenu-secondary: <?php echo e($submenuSecondaryColor); ?>; --submenu-hover-text: <?php echo e($submenuHoverTextColor); ?>;">
                            <?php $__currentLoopData = $activeSectionItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sectionItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <a href="<?php echo e(route('public.submenu', ['section' => $sectionKey, 'slug' => $sectionItem['slug']])); ?>" class="sidebar-program-link group block rounded-2xl px-3.5 py-3 text-sm transition duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#22323C]/35 <?php echo e($activeSubmenuItem ? 'sidebar-program-link-active shadow-sm' : ''); ?>">
                                    <span class="sidebar-program-link-title block font-semibold"><?php echo e($sectionItem['title']); ?></span>
                                    <span class="sidebar-program-link-meta mt-1 block text-xs"><?php echo e($activeSubmenuItem ? 'Current page' : 'Open page'); ?></span>
                                </a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                            ...
                            <div class="mt-4 rounded-2xl border bg-slate-50 p-4" style="border-color:#22323C;">
                                ...
                                <a href="<?php echo e(route('public.contact')); ?>" class="mt-3 inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-semibold text-slate-800 ring-1 ring-slate-300 transition duration-200 hover:-translate-y-0.5 hover:ring-slate-500">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="h-4 w-4"><path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5A2.25 2.25 0 0 1 19.5 19.5H4.5a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5H4.5a2.25 2.25 0 0 0-2.25 2.25m19.5 0L12 13.5 2.25 6.75"/></svg>
                                    Contact Team
                                </a>
                            </div>

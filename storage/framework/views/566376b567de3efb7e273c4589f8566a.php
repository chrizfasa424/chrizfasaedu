                ...
                <div class="relative overflow-hidden rounded-[2rem] border border-slate-200/80 bg-white/95 p-6 shadow-[0_24px_50px_-38px_rgba(15,23,42,0.5)] lg:p-8">
                    ...
                    <div class="relative space-y-8">
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            <span class="inline-flex items-center rounded-full border border-slate-200 bg-white px-3.5 py-1 text-[11px] font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e($readingMinutes); ?> min read</span>
                        </div>
                        ...
                        <div class="grid gap-4 sm:grid-cols-12">
                            <?php if($pageImgOne !== ''): ?>
                            <figure class="overflow-hidden rounded-3xl border border-slate-100 bg-white shadow-sm <?php echo e($pageImgTwo !== '' ? 'sm:col-span-8' : 'sm:col-span-12'); ?>">
                    ...
                    <aside class="self-start overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white shadow-[0_24px_50px_-40px_rgba(15,23,42,0.55)] lg:sticky lg:top-28">
                        ...
                        <div class="p-4">
                            ...
                            <?php $__currentLoopData = $activeSectionItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sectionItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <a href="<?php echo e(route('public.submenu', ['section' => $sectionKey, 'slug' => $sectionItem['slug']])); ?>" class="sidebar-program-link group block rounded-2xl border px-3.5 py-3 text-sm transition duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2D1D5C]/35 <?php echo e($activeSubmenuItem ? 'sidebar-program-link-active shadow-sm' : ''); ?>">

...
<head>
    ...
    <title>Student Portal — <?php echo e($schoolName); ?></title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap" rel="stylesheet">
    <style>
        body { font-family: 'Inter', sans-serif; background: #f8fafc; }
        .portal-left { background: linear-gradient(160deg, <?php echo e($primary); ?> 0%, <?php echo e($primary); ?>dd 60%, <?php echo e($primary); ?>bb 100%); }
        .input-field { transition: all 0.2s; border: 1.5px solid #e2e8f0; }
        .input-field:focus { outline: none; border-color: <?php echo e($primary); ?>; box-shadow: 0 0 0 3px <?php echo e($primary); ?>26; }
        .submit-btn { background: <?php echo e($primary); ?>; color: <?php echo e($secondary); ?>; }
        .submit-btn:hover { filter: brightness(1.1); transform: translateY(-1px); box-shadow: 0 10px 25px <?php echo e($primary); ?>40; }
        .submit-btn:active { transform: translateY(0); }
        .accent-text { color: <?php echo e($secondary); ?>; }
        .accent-bg   { background: <?php echo e($secondary); ?>; }
        .toggle-btn { color: <?php echo e($primary); ?>; }
...
<body class="min-h-screen flex items-center justify-center px-4 py-12">
    ...
    <div class="pointer-events-none fixed inset-0 overflow-hidden">
        <div class="absolute -top-40 -left-40 h-[500px] w-[500px] rounded-full opacity-10 blur-3xl" style="background:<?php echo e($primary); ?>;"></div>
        <div class="absolute -bottom-40 -right-40 h-[400px] w-[400px] rounded-full opacity-10 blur-3xl" style="background:<?php echo e($primary); ?>;"></div>
    </div>
            ...
            <div class="portal-left lg:w-[42%] relative flex flex-col justify-between overflow-hidden px-10 py-12">
                ...
                <div class="relative z-10">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-base font-extrabold text-white"><?php echo e($schoolName); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative z-10 flex-1 flex flex-col justify-center py-10">
                    ...
                    <div class="mt-8 space-y-3">
                        ...
                        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$emoji, $label]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center gap-3 rounded-2xl bg-white/15 px-4 py-3 backdrop-blur-sm">
                            <span class="text-base leading-none"><?php echo e($emoji); ?></span>
                            <span class="text-sm font-medium text-white"><?php echo e($label); ?></span>
                        </div>
                ...
                <div class="relative z-10">
                    <p class="text-xs text-white/40">&copy; <?php echo e(date('Y')); ?> <?php echo e($schoolName); ?></p>
                </div>
            </div>
            ...
            <div class="flex flex-1 flex-col justify-center px-8 py-12 sm:px-12">
                ...
                <div class="mb-6 flex items-start gap-3 rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3">
                    ...
                    <p class="text-xs text-amber-700">
                        ...
                        <a href="<?php echo e(route('login')); ?>" class="font-bold underline hover:text-amber-900">admin login</a>.
                    </p>
                </div>
                ...
                <div class="mb-5 flex items-start gap-3 rounded-2xl border border-red-200 bg-red-50 px-4 py-3">
                    ...
                    <p class="text-sm text-red-700"><?php echo e($errors->first('email')); ?></p>
                </div>
                <?php endif; ?>

                <form method="POST" action="<?php echo e(route('portal.login.submit')); ?>" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="flex items-center justify-between pt-1">
                        ...
                        <a href="<?php echo e(route('portal.password.request')); ?>" class="text-xs font-medium transition" style="color:<?php echo e($primary); ?>;">
                            Forgot password?
                        </a>
                    </div>
...
<?php /**PATH C:\wamp64\www\chrizfasaedu\resources\views/auth/portal-login.blade.php ENDPATH**/ ?>
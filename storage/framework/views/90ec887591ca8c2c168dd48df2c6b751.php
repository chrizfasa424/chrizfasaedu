        ...
        <div class="hidden lg:flex lg:w-[45%] xl:w-[40%] flex-col justify-between px-14 py-14 relative overflow-hidden"
            ...
            <div class="relative z-10 flex items-center gap-4">
                ...
                <div>
                    ...
                    <h1 class="text-lg font-bold text-white"><?php echo e(config('app.name')); ?></h1>
                </div>
            </div>
            ...
            <div class="relative z-10 flex-1 flex flex-col justify-center py-12">
                ...
                <div class="mt-10 space-y-3.5">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$label, $path]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-sm" style="color:rgba(199,210,254,0.75);"><?php echo e($label); ?></span>
                    </div>
            ...
            <div class="relative z-10">
                <p class="text-xs" style="color:rgba(165,180,252,0.35);">&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?>. All rights reserved.</p>
            </div>
        </div>
        ...
        <div class="flex flex-1 items-center justify-center bg-slate-950 px-6 py-14 sm:px-12 lg:border-l lg:border-slate-800">
            <div class="w-full max-w-sm">
                ...
                <div class="mb-8 lg:hidden">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-bold text-white"><?php echo e(config('app.name')); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-5 flex items-start gap-3 rounded-xl border border-emerald-700/40 bg-emerald-900/20 px-4 py-3">
                    ...
                    <p class="text-sm text-emerald-400"><?php echo e(session('status')); ?></p>
                </div>
                <?php endif; ?>
                ...
                <div class="mb-5 flex items-start gap-3 rounded-xl border border-red-800/50 bg-red-900/20 px-4 py-3">
                    ...
                    <p class="text-sm text-red-400"><?php echo e($errors->first('email')); ?></p>
                </div>
                <?php endif; ?>
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-4">
                    ...
                    <div class="flex items-center justify-between pt-1">
                        ...
                        <a href="<?php echo e(route('admin.password.request')); ?>" class="text-xs font-medium text-indigo-400 hover:text-indigo-300 transition">
                            Forgot password?
                        </a>
                    </div>
                ...
                <div class="mt-8 border-t border-slate-800 pt-6">
                    ...
                    <a href="<?php echo e(route('portal.login')); ?>"
...
<?php /**PATH C:\wamp64\www\chrizfasaedu\resources\views/auth/login.blade.php ENDPATH**/ ?>
...
class NigeriaData
{
    public static function statesWithLgas(): array
    {
        return [
            ...
            'Osun'        => ['Atakunmosa East','Atakunmosa West','Aiyedade','Aiyedire','Boluwaduro','Boripe','Ede North','Ede South','Egbedore','Ejigbo','Ife Central','Ife East','Ife North','Ife South','Ifedayo','Ifelodun','Ila','Ilesa East','Ilesa West','Irepodun','Irewole','Isokan','Iwo','Obokun','Odo Otin','Ola Oluwa','Olorunda','Oriade','Orolu','Osogbo'],
    ...
    {
        return array_keys(self::statesWithLgas());
    }

    public static function lgasFor(string $state): array
    {
        return self::statesWithLgas()[$state] ?? [];
    }
}
